        ...
        <Card className="p-6">
          ...
          {session ? (
            <p className="mt-2 text-3xl font-bold text-[#C9922A]">
              {resolvedRollNumber || "Not assigned yet"}
            </p>
          ) : (
